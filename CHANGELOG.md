...
- Included `hubspot_[source_table_name]_identifier` variable within the QuickBooks source package for additional flexibility within the package when source tables are named differently.
