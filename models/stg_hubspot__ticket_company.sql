...
with base as (
    ...
    select
        ...
        {% if fivetran_utils.remove_prefix_from_columns(columns=adapter.get_columns_in_relation(ref('stg_hubspot__ticket_company_tmp')), prefix='property_hs_',exclude=get_macro_columns(get_ticket_company_columns())) | length > 0 %},{% endif %}
        {{ 
